...
public class InvoicesService {
    ...
    public static String generateInvoiceHtml(
        ...
        html.append(".header { border-bottom: 3px solid #ff6600; padding-bottom: 20px; margin-bottom: 30px; }");
        ...
        html.append(".company-info h3, .customer-info h3 { color: #ff6600; margin-bottom: 10px; font-size: 14px; text-transform: uppercase; }");
        ...
        html.append("th { background: #ff6600; color: white; padding: 12px; text-align: left; font-weight: 600; }");
        ...
        html.append(".payment-info { background: #f0f9ff; padding: 15px; border-left: 4px solid #ff6600; margin: 20px 0; }");
        html.append("</style>");
        html.append("</head>");
        html.append("<body>");
